...
export function Footer() {
  return <footer className="site-footer"><div className="container footer-grid">
    ...
    <div><h3>Community</h3><Link href="/school-policies">Safeguarding</Link><Link href="/get-involved">Donate</Link><Link href="/sponsor-a-child">Sponsor a Child</Link><Link href="/school-exchange-programmes">Partner With Us</Link></div>
    <div className="footer-contact"><h3>Stay in touch</h3><p>Kitanyata 1 LCI, Kiruli Sub-county,<br />Buruli County, Masindi District, Uganda</p><p>Along Kyatiri–Kitanyata Road, approximately 8 km from Kyatiri Town</p><p>Telephone: +256 766 610 442 / +256 771 477 454</p><p>WhatsApp: +256 775 749 226</p><a href="mailto:info@amhs.sc.ug">info@amhs.sc.ug</a><p>P.O. Box: 480486 Masindi</p><div className="socials" aria-label="Social media links"><a href="https://www.facebook.com/" aria-label="Facebook" target="_blank" rel="noreferrer"><FacebookIcon /></a><a href="https://www.instagram.com/" aria-label="Instagram" target="_blank" rel="noreferrer"><InstagramIcon /></a><a href="https://www.youtube.com/" aria-label="YouTube" target="_blank" rel="noreferrer"><YoutubeIcon /></a></div></div>
