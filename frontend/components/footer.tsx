...
export function Footer() {
  return <footer className="site-footer"><div className="container footer-grid">
    <div className="footer-brand"><div className="brand"><span className="crest"><b>A</b><i>★</i><strong>MHS</strong></span><span>Asaba Memorial<br /><strong>High School</strong></span></div><p>A caring, ambitious community where young people learn, lead and serve.</p></div>
